"""
fetch_kis_flow.py  v5.1 (production-final)
────────────────────────────────────────────
✔ parse_net 스케일 불일치 수정 (log1p 복구)
✔ score 안정성 확보 (±0.2~±0.8 분포 목표)
✔ 기존 v5.0 구조 유지 + 수치 일관성 개선
"""
...
def _update_state(key: str, score: float, confidence: float):
    ...
    _error_counts[key] = 0  # ✅ recovery reset
