"""
engine.py — v6.4.4-KIS-REGIME
─────────────────────────────────────────────
✔ KIS 실시간 가격 + 거래량 주입
✔ 시장 국면 Regime + 신뢰도 Confidence 계산
✔ 신뢰도에 따라 entry_count 동적 조절
─────────────────────────────────────────────
"""
...
def run():
    print("[START] v6.4.4-KIS-REGIME", datetime.now(KST).strftime("%Y-%m-%d"))
    token = get_token()
    ...
    print("[DONE] v6.4.4-KIS-REGIME", datetime.now(KST).strftime("%Y-%m-%d"))
