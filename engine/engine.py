"""
engine/engine.py — v24.7 FINAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
파이프라인: fetch_data.py → data.json → engine.py → result.json

수정 내역:
  - dart_score KeyError 완전 수정 (merge 후 컬럼 존재 확인)
  - NaN / Inf → null 변환 (JSON 파싱 오류 방지)
  - foreign_net / inst_net 컬럼 안전 처리
  - DART 조회 20일, 키워드 정교화, 평균 편향 제거
  - IC log append 누적 구조
  - history.csv 중복 방지
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
