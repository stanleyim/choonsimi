"""
RegimeEngine v6.2.1 FINAL — Institutional Production Grade
────────────────────────────────────────────────────
✔ Soft Penalty
✔ Flow Normalization
✔ Adaptive Regime Filter
✔ ETF / ETN HARD BLOCK (Engine-level safety gate)
✔ FULL Tracker (verify + signal history safe write)
✔ Data Quality Monitor
✔ Backtest-ready architecture
✔ Corruption-safe CSV handling
────────────────────────────────────────────────────
"""
...
# ───────── ETF / ETN HARD FILTER (FINAL GATE) ─────────
...
class RegimeEngine:
    ...
    def pre_filter(self, stocks, regime):
        ...
        return [
            ...
            and is_common_stock(s.get("name"))   # 🔥 ETF HARD BLOCK
        ]
    ...
    def verify(self):
        ...
        try:
            ...
            price_map = {k:v for k,v in price_map.items() if v > 0}
