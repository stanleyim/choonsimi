"""
engine.py — v6.5.2 FINAL
─────────────────────────────────────────────────────
✔ v6.5.1 전체 로직 유지
✔ get_token() .seconds → .total_seconds() 버그 수정
─────────────────────────────────────────────────────
"""
...
# ── 경로 (engine/engine.py → 2단계 상위 = repo root) ──
...
def get_token():
    try:
        ...
        # ✅ FIX v6.5.2: .seconds → .total_seconds() (하루 이상 경과 시 오작동 방지)
...
# ═══════════════════════════════════════════════════════
# SIGNAL HISTORY SAVE  ← leading zero 보존
# ═══════════════════════════════════════════════════════
...
def run():
    ...
    print(f"[START] engine v6.5.2  {today}")
