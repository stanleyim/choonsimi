...
TARGET_SIZE = 200
SLEEP_SEC   = 0.15   # ✅ 0.35 → 0.15
TIMEOUT     = 10     # ✅ 30 → 10
WORKERS     = 2      # ✅ 병렬 처리 (DART API 분당 제한 안전)
...
def get_fallback_quarters() -> list:
    ...
    # 현재 분기 판단
    if m <= 3:   base = [(y-1,"4Q"),(y-1,"3Q"),(y-1,"2Q"),(y-1,"1Q")]
    elif m <= 6: base = [(y,"1Q"),  (y-1,"4Q"),(y-1,"3Q"),(y-1,"2Q")]
    elif m <= 9: base = [(y,"2Q"),  (y,"1Q"),  (y-1,"4Q"),(y-1,"3Q")]
    else:        base = [(y,"3Q"),  (y,"2Q"),  (y,"1Q"),  (y-1,"4Q")]
    return base
